package com.example.movildilo.ui.proveedores
...
class ProveedoresActivity : AppCompatActivity() {
    ...
    private lateinit var btnNuevoProveedor: ExtendedFloatingActionButton
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent.getStringExtra(ZoeActionRouter.EXTRA_ACCION) ==
            ZoeActionRouter.Accion.CREAR_PROVEEDOR
        ) {
    ...
    private fun abrirDialogoProveedor(proveedorParaEditar: ProveedorResponseDto?) {
        ...
        val adapterCat =
            ArrayAdapter(this, android.R.layout.simple_dropdown_item_1line, nombresCategorias)
