...
object ZoeOnboardingManager {
    ...
    private fun pasosPropietario() = listOf(
        ...
        GuiaPaso(
            ...
            "Aqui puedes ver las estadísticas de tu negocio, rachas de ventas, zonas de calor de demanda y comparativas de desempeño.",
            RendimientoComercialActivity::class.java
        ),
        GuiaPaso(
            "Mi Equipo",
