...
object ZoeOnboardingManager {
    ...
    private fun pasosFacturacionPorVoz() = listOf(
        GuiaPaso(
            "Bodegas",
            "Che, arranquemos por las bodegas. Acá creás tus puntos de almacenamiento físico para organizar dónde guardás la mercadería y controlar el stock.",
            BodegasActivity::class.java
        ),
        GuiaPaso(
            "Proveedores",
            "Acá está el directorio de tus proveedores, quienes te proveen los productos que necesitás.",
            ProveedoresActivity::class.java
        ),
        GuiaPaso(
            "Compras (Abastecimiento)",
            "En esta sección registrás las compras a tus proveedores para ingresar stock nuevo a tus bodegas.",
            ComprasActivity::class.java
        ),
        GuiaPaso(
            "Categorías",
            "Acá organizás tu catálogo en categorías para encontrar todo mucho más rápido.",
            CategoriasActivity::class.java
        ),
        GuiaPaso(
            "Catálogo de Productos",
            "Acá registrás los productos con su precio, marca e IVA para poder venderlos.",
            CatalogoProductosActivity::class.java
        ),
        GuiaPaso(
            "Clientes",
            "Acá guardás los datos de tus clientes para asociarlos de forma directa a las facturas.",
            ClientesActivity::class.java
        ),
        GuiaPaso(
            "Facturas y Ventas",
            "¡Listo, che! Ya tenés todo lo necesario. Acá podés emitir facturas o usar mi voz: decime el cliente, la bodega y los productos juntos, y yo armo el ticket por vos.",
