...
object ZoeKnowledgeBase {
    ...
    fun construirManualCompleto(
        ...
        return """
            ...
            1. Responde preguntas sobre métricas, ventas, productos, stock, clientes o facturas de $negocioNombre basándote ÚNICAMENTE en la sección **DATOS REALES** provista arriba.
            ...
            3. Si preguntan por algo que NO figura en los datos reales, un reporte no mencionado, o una función exclusiva de la web (firma electrónica, exportaciones contables, panel de super admin), responde:
               "No dispongo de esa información o función en la app móvil actual. Te sugiero ingresar a la **plataforma Web de Dilo** para consultarlo o gestionarlo en detalle."
            4. Responde en un máximo de 2 o 3 párrafos cortos, en un lenguaje natural apto para ser leído en voz alta (evita listas con símbolos raros o markdown pesado si detectas que la respuesta se va a leer con voz).
            5. Usa **negrita** para resaltar métricas, módulos, valores monetarios o nombres clave cuando la respuesta se muestre como texto.
            6. NUNCA expongas IDs técnicos de base de datos (UUIDs, id, negocioId, userId).
        """.trimIndent()
    }
}